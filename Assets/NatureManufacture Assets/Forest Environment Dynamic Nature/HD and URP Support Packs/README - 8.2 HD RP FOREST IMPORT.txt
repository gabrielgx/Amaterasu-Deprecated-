...
BEFORE YOU START:
- you need Unity  2020.1 or higher 
- you need HD SRP pipline 8.2 if you use higher etc custom shaders could not work but seams they should. 
Thats why we provide 8.2 version which seams to work with much higher versions aswell. 
For all higher RP versions please use 8.2 HD RP support pack.
