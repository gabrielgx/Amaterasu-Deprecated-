...
namespace Animancer.Examples.StateMachines.InterruptManagement
{
    ...
    /// https://kybernetik.com.au/animancer/api/Animancer.Examples.StateMachines.InterruptManagement/Creature
    /// 
    [AddComponentMenu(Strings.ExamplesMenuPrefix + "Interrupt Management - Creature")]
    [HelpURL(Strings.DocsURLs.ExampleAPIDocumentation + nameof(StateMachines) + "." + nameof(InterruptManagement) + "/" + nameof(Creature))]
